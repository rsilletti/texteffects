 ...
 */
/**
 * Applies text as defined in the "alt" attribute of any source element of class "rollover_src"
 ...
 *
 * @example  first source link : <a href="mysite.com" class="rollover_src" alt="My Site Info" title="Home">My Link</a>
 * @result  html : <p id="rollover_dest">My Site Info</p> on mouseover <p id="rollover_dest">Thanks for dropping by!</p> on mouseout.
 *
 * @example  second source link : <a href="exitlink.com" class="rollover_src" alt="Alternate Site Info" title="Aternate">Alternate Site</a>
